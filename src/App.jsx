    ...
    <>
      <main className="max-w-7xl mx-auto">
        ...
        <div className="hidden md:hidden lg:block">
          <div className=" flex justify-between items-center h-8 layoutbg-color text-white p-4 ">
            <div>
            ...
            <div className="flex gap-6 justify-center items-center">
              ...
              <div className="flex gap-4">
                <a className="hover:cursor-pointer border-x-2 border-white p-2">
                  <svg
        ...
        {/* 2nd part */}
        <div className="hidden md:hidden lg:block ">
          <div className="flex items-center justify-between h-20 md:h-40 bg-white w-full p-4 dark:border-y-2 dark:border-gray-500  dark:bg-slate-800 dark:text-white">
            <div>
              <h1 className=" dark:text-white font-extrabold text-[#0d0744]">
        ...
        {/* Navigation */}
        <div className="flex justify-center items-center sm:block  md:block lg:hidden layoutbg-color">
          <h1 className="font-semibold text-white text-center p-4">
            DREAM STUDY INTERNATIONAL
          </h1>
        </div>
        ...
        <section className=" dark:bg-slate-800 dark:border-y-2 dark:border-white sm:my-4">
          <h1 className="uppercasae flex justify-center items-center font-extrabold text-blue-800 dark:text-white my-8 ">
            DREAM STUDY INTERNATIONAL
          </h1>

          {/* from and image section */}
          <div className="max-w-full sm:grid-cols-1 md:grid-cols-1 lg:flex lg:justify-between gap-4  md:px-4 md:mb-2">
            <div className="sm:w-full md:max-w-full sm:my-4 lg:w-2/3 py-8 ">
              <img
                src="/add.PNG"
                alt="study add image"
            ...
            {/* form */}
            <div className="sm:w-full sm:py-10 md:max-w-full lg:w-1/3 bg-white rounded-2xl shadow-sm shadow-gray-400 overflow-hidden ">
              <h2 className="text-xl sm:text-2xl font-bold text-white bg-gradient-to-r from-blue-500 to-blue-700 md:px-6 p-4 ">
                Apply Now!
              </h2>
              <form className="space-y-4 p-6 md:max-w-full">
                <input
                  type="text"
                  placeholder="Name"
        ...
        {/* use dark mode */}
        <div className="bg-gray-50 dark:border-t-2 dark:border-gray-500  dark:bg-slate-800">
        ...
        {/* footer section */}
        <footer className="bg-gray-100 text-black py-12  dark:bg-slate-800 dark:text-white dark:border-y-2 dark:border-gray-500">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="bg bg-white shadow-sm shadow-gray-200 rounded-xl p-4 dark:text-black">
        ...
        <div className="flex border-t border-gray-800 p-2 flex-col sm:justify-center sm:items-center justify-between layoutbg-color items-center text-gray-400 max-w-7xl">
          ...
          <div>
            <ul className="space-x-4 flex items-center justify-center">
              <li>
                <a href="#" className="footer-hover mouse-effect">
                  About
                </a>
              </li>
              <li>
